...
IGL_INLINE bool SelectionPlugin::post_draw() 
{
  ...
  ImGui::Begin("testing", nullptr, ImGuiWindowFlags_NoFocusOnAppearing | ImGuiWindowFlags_NoBackground | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoInputs);
  float width, height;
  float highdpi = 1.0;
  {
    int fwidth, fheight;
